...
const courses = [
  ...
  },
  {
    ...
    desc: 'Развитие вокальных данных, сценического мастерства и артистизма. Участие в концертах и творческих конкурсах.',
    age: '6–18 лет',
    duration: 'Весь год',
    icon: 'Mic',
    color: 'hsl(180,55%,45%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Хореография, пластика, ритмика и сценическое движение. Воспитание культуры тела и художественного вкуса.',
    age: '5–18 лет',
    duration: 'Весь год',
    icon: 'Music',
    color: 'hsl(320,65%,58%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Всестороннее развитие личности: творчество, коммуникация, саморазвитие и гармоничное мировосприятие.',
    age: '6–18 лет',
    duration: 'Весь год',
    icon: 'Heart',
    color: 'hsl(340,70%,58%)',
  ...
  },
  {
    ...
    title: '«Юнармеец»',
    category: 'Образовательные',
    desc: 'Военно-патриотическое воспитание, строевая подготовка, история Отечества и гражданская ответственность.',
    age: '10–18 лет',
    duration: 'Весь год',
    icon: 'Star',
    color: 'hsl(0,70%,50%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Прикладное творчество, поделки, декоративное искусство и развитие фантазии через ручной труд.',
    age: '6–14 лет',
    duration: 'Весь год',
    icon: 'Wand2',
    color: 'hsl(42,90%,55%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Творческое объединение для развития воображения, художественных способностей и нестандартного мышления.',
    age: '6–14 лет',
    duration: 'Весь год',
    icon: 'Sparkles',
    color: 'hsl(270,65%,60%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Основы моды, дизайна одежды, шитьё и стилистика. Создание собственных коллекций и творческих образов.',
    age: '8–18 лет',
    duration: 'Весь год',
    icon: 'Scissors',
    color: 'hsl(310,60%,58%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Патриотическое объединение: воинские традиции, физическая подготовка и воспитание гражданского долга.',
    age: '10–18 лет',
    duration: 'Весь год',
    icon: 'Shield',
    color: 'hsl(10,65%,50%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Изучение правил дорожного движения, пропаганда безопасности на дорогах, работа с младшими школьниками.',
    age: '8–16 лет',
    duration: 'Весь год',
    icon: 'Traffic',
    color: 'hsl(200,75%,50%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Рисунок, живопись, композиция. Развитие художественных навыков и эстетического восприятия мира.',
    age: '5–18 лет',
    duration: 'Весь год',
    icon: 'Palette',
    color: 'hsl(25,80%,55%)',
  ...
  },
  {
    ...
    category: 'Образовательные',
    desc: 'Изучение английского языка: разговорная речь, грамматика, лексика и подготовка к международным стандартам.',
    age: '6–18 лет',
    duration: 'Весь год',
    icon: 'BookOpen',
    color: 'hsl(215,70%,55%)',
